...
# import pandas as pd
# import re
# data = pd.read_csv('../ks-projects-201801.csv', usecols=[5])
...
# 2017月{'Food': 3221, 'Art': 3972, 'Technology': 6160, 'Theater': 905, 'Music': 4951, 'Design': 5923, 'Journalism': 652, 'Publishing': 5283, 'Fashion': 4167, 'Film & Video': 5561, 'Crafts': 1561, 'Games': 6951, 'Comics': 1997, 'Dance': 378, 'Photography': 1059}
...
data = pd.read_csv('../ks-projects-201801.csv', usecols=[3, 5])
dic = {}
for item in np.arange(0, len(data)):
